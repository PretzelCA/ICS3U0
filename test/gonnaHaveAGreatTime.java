...
public class gonnaHaveAGreatTime {
    public static void main(String[] args) {
        String studentList[][] = new String[4][20];
        ...
        studentList[2][12] = "AAAAA I HAVE THE EXAM IN AN HOUR LMAOOO CAN I REMEMBER SHIT IDK LETS SEE";
